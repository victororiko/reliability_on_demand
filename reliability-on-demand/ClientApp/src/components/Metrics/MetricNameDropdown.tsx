...
export const MetricNameDropdown = (props: Props) => {
    ...
    const [defaultMetrics, setDefaultMetrics] = useState<Metric[]>(props.defaultMetrics)
    ...
    useEffect(() => {
        ...
        const dropdownOptions = generateDropdownOptions(cleanedDefaults, cleanedUserMetrics)
