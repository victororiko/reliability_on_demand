...
import { StudyConfig, getFrequencySelectionFromStudy } from "../../models/study.model"
...
export const FrequencyDropdown = (props: Props) => {
    ...
    useEffect(() => {
        const ans = getFrequencySelectionFromStudy(hardCodedFrequencies, props?.currentStudy)
        setSelection(ans)
    }, [props.currentStudy])
