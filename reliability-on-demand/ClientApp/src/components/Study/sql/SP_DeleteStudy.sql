...
WHERE SPECIFIC_SCHEMA = N'dbo'
    AND SPECIFIC_NAME = N'DeleteStudy'
)
DROP PROCEDURE dbo.DeleteStudy
GO
/****** Object:  StoredProcedure [dbo].[DeleteStudy]    Script Date: 3/4/2022 6:00:29 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[DeleteStudy]
