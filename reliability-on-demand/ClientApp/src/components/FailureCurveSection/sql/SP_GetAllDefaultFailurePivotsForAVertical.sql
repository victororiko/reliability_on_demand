/****** Object:  StoredProcedure [dbo].[GetAllDefaultFailurePivotsForAVertical]    Script Date: 7/20/2022 2:46:12 PM ******/
SET ANSI_NULLS ON
GO
...
AS
    ...
    SELECT info.PivotID,info.PivotSourceColumnName,info.UIInputDataType,info.PivotKey
